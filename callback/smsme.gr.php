...
$params["gateway"] = 'mygateway'; #REQUIRED (gateway's filename)
...
$params["sms_id"] = $_POST["apiMsgId"]; #REQUIRED (gateway's smsid)
$params["sms_status"] = $NewStatusNumber; # accepted values 0 to 3
$params["sms_cost"] = $_POST["charge"]; #Upadte the sms cost in credits
